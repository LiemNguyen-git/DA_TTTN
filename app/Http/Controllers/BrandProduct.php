...
class BrandProduct extends Controller
{
    ...
    {
        $this->AuthLogin();
        $brand_id = DB::table('tbl_product')->join('tbl_brand_product','tbl_product.brand_id','=','tbl_brand_product.brand_id')->where('tbl_product.brand_id',$brand_id)->get();
        if ($brand_id) {
            Session::put('message','Không thể xóa do có sản phẩm');
            return Redirect::to('all-brand-product');
        }
        else{
