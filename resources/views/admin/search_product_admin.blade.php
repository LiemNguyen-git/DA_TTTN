    ...
    <div class="row w3-res-tb">
      ...
      <div class="col-sm-3">
        ...
        <div class="input-group">
          <input type="text" class="input-sm form-control" name="keywords_search" placeholder="Nhập sản phẩm cần tìm kiếm">
          <span class="input-group-btn">
            <button class="btn btn-sm btn-default" type="submit">Tìm</button>
          </span>
        </div>
        <h4>Số sản phẩm tìm được là:
              <?php
            $na = Count($search_product);
               echo "$na";
            ?>
            </h4>
      </form>
