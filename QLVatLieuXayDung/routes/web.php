...
Route::post('/tim-kiem-tang-dan','HomeController@search_tangdan');
Route::post('/tim-kiem-giam-dan','HomeController@search_giamdan');
...
Route::post('/tim-kiem-loai', 'AdminController@search_category_admin');
Route::post('/tim-kiem-thuong-hieu', 'AdminController@search_brand_admin');
Route::post('/tim-kiem-san-pham', 'AdminController@tim_kiem_san_pham');
// quản lý đơn hàng=================================================
