...
class BrandProduct extends Controller
{
    ...
    public function show_brand_home($brand_id)
        {   
            ...
            $dem_brand = DB::table('tbl_product')->join('tbl_brand_product','tbl_brand_product.brand_id','=','tbl_product.brand_id')->select('tbl_product.brand_id','tbl_brand_product.brand_id')->orderby('tbl_product.brand_id','desc')->get()->toArray();
            ...
            $brand_name = DB::table('tbl_brand_product')->where('tbl_brand_product.brand_id',$brand_id)->limit(6)->get();//lay tat ca ten san pham cua 1 loai

            return view('pages.brand.show_brand')->with('category',$cate_product)->with('brand',$brand_product)->with('brand_by_id',$brand_by_id)->with('brand_name',$brand_name)->with('dem_brand',$dem_brand);
