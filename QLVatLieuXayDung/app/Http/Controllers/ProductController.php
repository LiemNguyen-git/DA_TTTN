...
class ProductController extends Controller
{
    ...
    /*public function show_comment(Request $request)   
    {
        ...
        $manage_comment = view('pages.sanpham.show_comment')->with('comment_product',$comment_product);
            return view('pages.sanpham.show_comment')->with('pages.sanpham.show_comment',$manage_comment);
    }*/
   /* public function save_comment(Request $request)   
    {
            $data = array();
            $data['content'] = $request->comment_content;
            $data['customer_name'] = $request->comment_name;
            $comment_id = DB::table('tbl_comment')->insertGetId($data);
            Session::put('comment_id',$comment_id);
        
        return Redirect('/show-comment');
    }*/
}
